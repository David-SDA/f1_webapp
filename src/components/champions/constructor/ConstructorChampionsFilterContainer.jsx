...
export default function ConstructorChampionsFilterContainer({
    search,
    handleSearchChange,
    filter,
        ...
        <Row className="d-flex flex-row align-items-center mb-3">
            ...
            <Col xs={10} sm={4} md={4} lg={3} className="mb-2">
                <Form.Select value={filter} onChange={handleFilterOptionChange} style={{fontFamily: "Formula1-Regular"}}>
                    ...
                    <option value="ConstructorStandings[0].Constructor.name">Name</option>
                    <option value="ConstructorStandings[0].Constructor.nationality">Nationality</option>
                </Form.Select>
            </Col>
