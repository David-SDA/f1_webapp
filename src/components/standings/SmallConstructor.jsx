...
export default function SmallConstructor({position, name}){
    const MyBar = {
        width: 7,
        height: 25,
        backgroundColor: "red"
    ...
    return (
        <Container className="d-flex flex-row justify-content-start align-items-center bg-white mb-2 rounded-3 p-2">
            ...
            <span className="text-center ms-auto p-2 rounded-5" style={{fontFamily: "Formula1-Bold", backgroundColor: "#e8e8e8", fontSize: 12}}>200 <span style={{fontFamily: "Formula1-regular"}}>PTS</span></span>
        </Container>
    );
}